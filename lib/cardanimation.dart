    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            AnimatedCrossFade(
                firstChild:Container(color: Colors.redAccent,height: 100,width: 100,), // Your first element here,
                secondChild:Container(color: Colors.blueAccent,height: 100,width: 100,), // Element after transition,
                crossFadeState: firstStateEnabled?CrossFadeState.showSecond:CrossFadeState.showFirst, // State of the transition,
